...
SRC_URI = "repo://git.ti.com/git/processor-sdk/psdk_repo_manifests.git;protocol=https;branch=refs/tags/REL.PSDK.ANALYTICS.SAFETY.11.01.00.02;manifest=vision_apps_yocto.xml"
...
SRC_URI:j721e = "repo://git.ti.com/git/processor-sdk/psdk_repo_manifests.git;protocol=https;branch=refs/tags/REL.PSDK.ANALYTICS.NONSAFETY.11.01.00.02;manifest=vision_apps_yocto_nonsafety.xml"
SRC_URI:j722s = "repo://git.ti.com/git/processor-sdk/psdk_repo_manifests.git;protocol=https;branch=refs/tags/REL.PSDK.ANALYTICS.NONSAFETY.11.01.00.02;manifest=vision_apps_yocto_nonsafety.xml"
FILES:${PN} += "/opt/*"
